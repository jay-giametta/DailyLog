...
{
    public class DecertifyEntryModel : PageModel
    {
        ...
        public DecertifyEntryModel(DailyLogDbContext db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> OnGet(int id)
        {
            ...
            DailyLogSummary.CertifiedBy = null;                                 //Update the record with the given entry edit. JG
